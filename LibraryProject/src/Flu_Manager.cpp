...
void Flu_Manager::loadInput()
{
	...
	FILE* houseFile = fopen("input_data/households.txt","r");
	...
	FILE* childAgeFile = fopen("input_data/age_child.txt","r");
	...
	FILE* adultAgeFile = fopen("input_data/age_adult.txt","r");
	...
	FILE* zipCodeFile = fopen("input_data/zipcode.txt","r");
	...
	FILE* travelFile = fopen("input_data/regions.txt","r");
	...
	gamma1File = fopen("input_data/gamma1.txt","r");
	...
	//create an array of gamma distribution columns
	gamma2File = fopen("input_data/gamma2.txt","r");
	for (int i = 0; i <= DISTRIBUTION_COLUMNS; ++i)
	{
		int dump;//integer to hold the first column value. It will be discarded. The index of gamaCurves = days of infectiousness
	...
	lognorm1File = fopen("input_data/lognorm1.txt","r");
	for (int i = 0; i <= DISTRIBUTION_COLUMNS; ++i)
	{
	...
	//create an array of lognormal distribution columns
	lognorm2File = fopen("input_data/lognorm2.txt","r");
	for (int i = 0; i <= DISTRIBUTION_COLUMNS; ++i)
	{
		int dump;//integer to hold the first column value. It will be discarded. The index of lognormalCurves = days of infectiousness
	...
	weib1File = fopen("input_data/weib1.txt","r");
	for (int i = 0; i <= DISTRIBUTION_COLUMNS; ++i)
	{
	...
	//create an array of weib distribution columns
	weib2File = fopen("input_data/weib2.txt","r");
	for (int i = 0; i <= DISTRIBUTION_COLUMNS; ++i)
	{
		int dump;//integer to hold the first column value. It will be discarded. The index of weibCurves = days of infectiousness
...
void Flu_Manager::loadConstants()
{
	...
	ALLOW_TRAVEL=0;
	FILE *input_constants=fopen("input_data/constants.txt","r");
...
//yuwen add sampling criteria end
	...
	_workFiles_scaled.push_back("input_data/workplaces_MI_region1_scaled_Jan14.txt");
	_workFiles_unScaled.push_back("input_data/workplaces_MI_region1_unscaled_Jan14.txt");
	_workFiles_scaled.push_back("input_data/workplaces_MI_region2_scaled_Jan14.txt");
	_workFiles_unScaled.push_back("input_data/workplaces_MI_region2_unscaled_Jan14.txt");
	_workFiles_scaled.push_back("input_data/workplaces_MI_region3_scaled_Jan14.txt");
	_workFiles_unScaled.push_back("input_data/workplaces_MI_region3_unscaled_Jan14.txt");
	_workFiles_scaled.push_back("input_data/workplaces_MI_region4_scaled_Jan14.txt");
	_workFiles_unScaled.push_back("input_data/workplaces_MI_region4_unscaled_Jan14.txt");
}
